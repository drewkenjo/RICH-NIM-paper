...
\centering 
  \subfloat[3 mm mask]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/CA7811_a.pdf}}\hfill
  \subfloat[No mask, cross talk removed by software]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/CA7811_b.pdf}} \\
  \subfloat[6 mm mask]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/CA7811_c.pdf}}\hfill
...
\centering 
  \subfloat[3 mm mask]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_1a.pdf}}\hfill
  \subfloat[No mask, cross talk removed by software]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_1b.pdf}} \\
  \subfloat[6 mm mask]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_1c.pdf}}\hfill
  \subfloat[No mask, cross talk approximated by fit]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
...
\centering 
  \subfloat[3 mm mask]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_2a.pdf}}\hfill
  \subfloat[No mask, cross talk removed by software]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_2b.pdf}} \\
  \subfloat[6 mm mask]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_2c.pdf}}\hfill
  \subfloat[No mask, cross talk approximated by fit]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
...
\centering 
  \subfloat[6 mm mask, at HV = 1000 V]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_4a.pdf}}\hfill
  \subfloat[6 mm mask, at HV = 1100 V]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_4b.pdf}} \\
  \subfloat[No mask, at HV = 1000 V]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
                    {figures/GA0516_4c.pdf}}\hfill
  \subfloat[No mask, at HV = 1100 V]{%
    \includegraphics[clip=true,trim=90 70 110 100,width=.48\textwidth,height=.25\textwidth]
