...
The systematical uncertainties for each measured parameter are evaluated by the comparison of its values obtained in six independent measurements performed for each MaPMT. Two HV by three illumination settings produced three independent values fo 
