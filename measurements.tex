...
\begin{figure}[ht]
	\centering
	\begin{tcolorbox}[halign=center,colback=white,colbacktitle=red!40!white,colframe=red!80!white,left=0pt,right=0pt,top=0pt,bottom=0pt,boxrule=4pt,title={\bfseries\color{black}The updated efficiency improvement is too small,\\to be removed}]
	\includegraphics[width=\linewidth]{figures/effratio.pdf}
