...
\centering 
  \subfloat[3 mm mask]{%
    \includegraphics[clip=true,trim=100 75 140 100,width=.245\textwidth]
...
\begin{figure*}[h!bt]
	...
	\caption{Illustration of the "MAPMT Passport" plots for one of the tubes, LA2527. The standard six measurements included runs at three illumination settings (wheel positions 3, 4, and 6), each at two operating high voltage values (1000 V, and 1100 V).}
