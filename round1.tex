...
\fbox{\includegraphics[width=\linewidth]{round1/2.09c-1.png}}
...
The systematical uncertainties for each measured parameter are evaluated by the comparison of its values obtained in six independent measurements performed for each MaPMT. Two high voltage by three illumination settings produced three independent measurements for the parameters not sensitive of illumination, such as $scale$, and the SPE spectrum shape parameters, and two independent measurements for the parameters not sensitive to HV, such as $\mu$. 
