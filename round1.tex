...
\fbox{\bfseries The number comes from the Hamamatsu specifications datasheet. No uncertainties may be found there, and in such case the understanding is that all the digits in the number are meaningful. The text of the paper was changed to address the comment. See before and after version below:}
